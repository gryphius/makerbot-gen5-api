...
if __name__ == '__main__':
    ...
    #All bots require an authorization code before allowing access. You can store the code in you config file if you'd like.
    
    #First we have to explicitly state that we are ok with saving the Auth code. 
    #The first argument is the serial number of bot, and the second arg is saying that we have permission to save.
